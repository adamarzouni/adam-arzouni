// ============================================================
// PROJECT DATA — THE ONLY PLACE YOU EVER NEED TO EDIT
// ============================================================
// To add a new project, paste a new object into this array.
// The bento grid card AND the modal are BOTH auto-generated.
//
// FIELDS:
//   id         — unique slug, no spaces (e.g. 'my-project')
//   titleEn    — English card/modal title
//   titleFr    — French card/modal title
//   cardLabel  — short subtitle shown on the bento card (e.g. award, tech, client)
//   cardLabelFr— French version of cardLabel
//   coverImg   — image shown on the bento card background (path relative to root)
//   layout     — card size: 'large' (2col×2row), 'wide' (2col×1row), or '' (normal)
//   descEn     — HTML string shown in modal (bold with <strong>, break with <br>)
//   descFr     — French HTML string for modal
//   link       — external link shown in modal; use '#' to hide the button
//   gallery    — array of image/video paths shown in modal gallery
//   docs       — array of { nameEn, nameFr, url, protected } objects
//               set protected: true to require password 'admin' before opening
// ============================================================
...
const projectsData = [
    {
        ...
        cardLabel: '1st Prize Winner',
        cardLabelFr: 'Gagnant 1er Prix',
        coverImg: 'images/PI1.jpg',
        layout: 'large',
    ...
    },
    {
        ...
        cardLabel: 'Smart Baby Monitoring',
        cardLabelFr: 'Surveillance Bébé',
        coverImg: 'images/PI3.jpg',
        layout: '',
    ...
    },
    {
        ...
        cardLabel: 'Autonomous Logistics',
        cardLabelFr: 'Logistique Autonome',
        coverImg: 'images/pi23.jpg',
        layout: '',
    ...
    },
    {
        ...
        cardLabel: 'Hydro-Quebec / IREQ',
        cardLabelFr: 'Hydro-Québec / IREQ',
        coverImg: 'images/riaupel-main.jpg',
        layout: 'wide',
    ...
    },
    {
        ...
        cardLabel: 'Wearable Development',
        cardLabelFr: 'Développement Portable',
        coverImg: 'images/tizen-main.jpg',
        layout: '',
    ...
    },
    {
        ...
        cardLabel: 'Audio Guestbook',
        cardLabelFr: 'Livre d\'Or Audio',
        coverImg: 'images/wedding1.jpg',
        layout: '',
    ...
    // -------------------------------------------------------
    // ADD A NEW PROJECT HERE — just copy+paste and fill in:
    // -------------------------------------------------------
    // ,{
    //     id: 'my-new-project',
    //     titleEn: 'My New Project',
    //     titleFr: 'Mon Nouveau Projet',
    //     cardLabel: 'Short subtitle',
    //     cardLabelFr: 'Sous-titre court',
    //     coverImg: 'images/my-cover.jpg',
    //     layout: '',        // '' | 'large' | 'wide'
    //     descEn: '<strong>Description here</strong>',
    //     descFr: '<strong>Description ici</strong>',
    //     link: '#',
    //     gallery: ['images/my-cover.jpg'],
    //     docs: []
    // }
];
...
// ============================================================
// AUTO-BUILD THE BENTO GRID FROM projectsData
// ============================================================
function buildProjectGrid() {
    ...
    projectsData.forEach(proj => {
        ...
        item.className = `bento-item ${proj.layout || ''}`.trim();

        // Use a data attribute for the background — defers loading via CSS
        item.setAttribute('data-bg', proj.coverImg);
        item.onclick = () => openProject(proj.id);
        ...
        item.innerHTML = `
            ...
            <div class="card-content">
                <h3 class="en">${proj.titleEn}</h3>
                <h3 class="fr">${proj.titleFr}</h3>
                <p class="en">${proj.cardLabel}</p>
                <p class="fr">${proj.cardLabelFr}</p>
                <span class="click-hint"><i class="fas fa-plus"></i> <span class="en">Click for Details</span><span class="fr">Voir Détails</span></span>
            </div>
        `;
...
// Lazy-load bento card backgrounds
...
// ============================================================
// MODAL — open by project id (string)
// ============================================================
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (ctaSecondary) {
        window.addEventListener('scroll', () => {
            if (window.scrollY > 50) ctaSecondary.classList.remove('pulsing');
            else ctaSecondary.classList.add('pulsing');
        });
    }
...
// expose for inline onclick on modal close
